function run(msg)
	...
	about_key = {{{text = "Bot Id" , url = "http://telegram.me/Tan_Tan"}},{{text = "Channel" , url = ""}},{{text = "پیام رسان سازنده" , url = "https://telegram.me/navidtantanpv_bot"}},{{text = "NavidTanTan" , url = "https://telegram.me/NavidTanTan"}}}
