function run(msg)
	...
	about_key = {{{text = "Bot Id" , url = "http://telegram.me/Mega_Maximus"}},{{text = "Channel" , url = "https://telegram.me/pedaret"}},{{text = "پیام رسان سازنده" , url = "https://telegram.me/megapmresan_bot"}},{{text = "AminYaghi" , url = "https://telegram.me/teshne"}}}
	...
	start_key = {{{text="ساخت ربات پیام رسان",url="https://telegram.me/megapmresan_bot"}}}
...
function inline(msg)
	...
	bioinfo = infotxtin.."*Name:* "..sudo_name.."\n*Username:* [@"..sudo_user.."](https://telegram.me/"..sudo_user..")\n*Mobile:* +"..sudo_num.."\n*Telegram ID:* "..sudo_id.."\n*Channel:* [@"..sudo_ch.."](https://telegram.me/"..sudo_ch..")\n\n_Powered by_ [AminYaghi](https://telegram.me/teshne)"
	tabless = '[{"text":"اکانت اصلی من","url":"https://telegram.me/'..sudo_user..'"}],[{"text":"کانال شخصی من","url":"https://telegram.me/'..sudo_ch..'"}],[{"text":"کانال سازنده","url":"https://telegram.me/pedaret"},{"text":"سازنده ربات","url":"https://telegram.me/megapmresan_bot"}]'
